...
label_paths = glob.glob('/Users/ryanzotti/Documents/Data/Self-Driving-Car/printer-paper/data/dataset_2_18-04-15/record_1566.json')
for label_path in label_paths:
    ...
    # In case you want to see rolling rmse
