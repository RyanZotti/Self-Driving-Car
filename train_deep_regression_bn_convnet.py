...
conv1 = batch_norm_pool_conv_layer('layer1', x, [3, 3, 3, 36], phase)
conv2 = batch_norm_pool_conv_layer('layer2',conv1, [3, 3, 36, 36], phase)
conv3 = batch_norm_pool_conv_layer('layer3',conv2, [3, 3, 36, 36], phase)
conv4 = batch_norm_pool_conv_layer('layer4',conv3, [3, 3, 36, 36], phase)
