...
conv1 = batch_norm_conv_layer('layer1',x, [3, 3, 3, 24], phase)
conv2 = batch_norm_conv_layer('layer2',conv1, [3, 3, 24, 24], phase)
conv3 = batch_norm_conv_layer('layer3',conv2, [3, 3, 24, 24], phase)

h_pool4_flat = tf.reshape(conv3, [-1, 240 * 320 * 24])
